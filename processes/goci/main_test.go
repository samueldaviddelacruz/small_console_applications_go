...
func TestRun(t *testing.T) {
	...
	var testCases = []struct {
		...
		{name: "fail", proj: "./testdata/toolErr", out: "", expErr: &stepError{step: "go build"}, setupGit: false},
		{name: "failFormat", proj: "./testdata/toolFmtErr", out: "", expErr: &stepError{step: "go fmt"}, setupGit: false},
	}
