...
func TestRun(t *testing.T) {
	...
	var testCases = []struct {
		...
		{name: "fail", proj: "./testdata/toolErr", out: "", expErr: &stepError{step: "go build"}, setupGit: false, mockCmd: nil},
		{name: "failFormat", proj: "./testdata/toolFmtErr", out: "", expErr: &stepError{step: "go fmt"}, setupGit: false, mockCmd: nil},
...
func TestHelperProcess(t *testing.T) {
	...
	if os.Args[2] == "git" {
		fmt.Fprintf(os.Stdout, "Everything up-to-date")
		os.Exit(0)
	}
	os.Exit(1)
}
